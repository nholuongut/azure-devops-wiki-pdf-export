...
**[azuredevops-export-wiki.exe](https://github.com/nholuongutnholuongut/azure-devops-wiki-pdf-export/releases)** (~30MB)
...
The download is available [here](https://github.com/nholuongutnholuongut/azure-devops-wiki-pdf-export/releases)
